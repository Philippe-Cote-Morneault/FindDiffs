...
export class SphereComponent implements AfterViewInit {
  ...
  private createCube(): void {
    ...
    const geometry: THREE.SphereBufferGeometry = new THREE.SphereBufferGeometry(3, 50, 50, 0, Math.PI * 2, 0, Math.PI * 2);
...
export class SphereComponent implements AfterViewInit {
  ...
  private createSphere(): void {
    ...
    const geometry: THREE.SphereBufferGeometry = new THREE.SphereBufferGeometry( 50, 320, 320 );
    this.sphere = new THREE.Mesh(geometry, material);

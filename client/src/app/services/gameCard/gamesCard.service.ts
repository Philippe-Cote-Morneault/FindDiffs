...
export class GamesCardService extends HTTPService {
    ...
    public addGameCard(gameName: string, ressourceId: string, pov: POVType): Observable<ICommonGameCard | Message> {
        const requestBody: Object = { "name": gameName, "resource_id": ressourceId, "pov": POVType[pov] };
